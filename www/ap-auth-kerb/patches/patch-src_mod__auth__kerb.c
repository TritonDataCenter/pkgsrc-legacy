...
This is a combination of a whole series of patches
One originally from pkgsrc
The rest taken from Fedora and applied in the same order that
Fedora applies them (see http://pkgs.fedoraproject.org/cgit/mod_auth_kerb.git/tree/)
 --
...
diff -ur src/mod_auth_kerb.c src/mod_auth_kerb.c
--- src/mod_auth_kerb.c	2008-12-04 10:14:03.000000000 +0000
+++ src/mod_auth_kerb.c	2014-02-13 15:01:19.411955943 +0000
@@ -42,6 +42,31 @@
